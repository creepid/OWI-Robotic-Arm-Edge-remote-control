...
{
        uniq1 = Math.random();
        document.images.webcam1.src = "http://localhost:8090/cam_" + currentCamera1 + ".jpg?uniq="+uniq1;
        document.images.webcam1.onload = DoIt1;
}
function PTZMouseDown1(e)
{
        ...
        if (x > 400) x = 400;
        if (y > 300) y = 300;
        if (myifr != null) myifr.src = "http://localhost:8090/ptz?src=" + currentCamera1 + "&moveto_x=" + x + "&moveto_y=" + y +"";
        return true;
}
function getElPos1()
{
...
function ErrorImage1()
{
        ...
        if (errorimg1>3){
              ...
              document.images.webcam1.src = "http://localhost:8090/offline.jpg";
              }else{
                uniq1 = Math.random();
            document.images.webcam1.src = "http://localhost:8090/cam_" + currentCamera1 + ".jpg?uniq="+uniq1;
              }
